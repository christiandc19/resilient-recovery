        ...
        <div className='footer'>
            <div className="container">
                <div className="top">
                    ...
                    <img src={logo} width="150px" height="60px" alt="Resilient Recovery Logo" loading="lazy"/>
                    </div>
                ...
                <p className='copyright'><p>&copy; 2023 RESILIENT RECOVERY TREATMENT CENTER. ALL RIGHTS RESERVED.</p></p>
